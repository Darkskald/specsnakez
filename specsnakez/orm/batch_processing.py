...
from specsnakez.core.sfg_spectrum import SfgAverager
from specsnakez.orm.interact import DbInteractor
...
class BatchProcessor:
    ...
    def get_spectrum_by_name(self, name: str):
        return self.interactor.session.query(self.interactor.sfg).filter(self.interactor.sfg.name == name).one()
